Bare metal experiments on the Firefly ROC-RK3328-CC board.
...
Connect Firefly ROC-RK3328-CC board gpio Pin 38 to serial USB cable RX.
Connect Firefly ROC-RK3328-CC board gpio pin 36 to serial USB cable TX. 
Connect Firefly ROC-RK3328-CC board gpio pin 39 to serial USB cable ground. 
Type "script ~/outputfile.txt" on PC.
Plugin serial USB cable to PC.
Type "sudo screen /dev/ttyUSB0 1500000" on PC.
Power on the Firefly ROC-RK3328-CC board.
